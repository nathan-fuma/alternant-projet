                ...
                <div class="col-md-12">
                    <div class="card demo-icons">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-user-graduate mr-2"></i>Liste des étudiants</h3>
                            <p class="card-category">Filtre par formation et/ou promotion</p>
                        </div>
                        <div class="card-body all-icons">
                            <div id="icons-wrapper">
                                <div class="table-responsive">
                                    <h1 class="text-center">Étudiants de vos formations</h1>
...
<script src="../assets/js/core/anneesFormation.js"></script>
